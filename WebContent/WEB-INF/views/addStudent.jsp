...
<h2 style="color:red">${errorMsg}</h2><br>
  ...
  <div class="form-group mx-sm-3 mb-2">
   ...
   <div class="form-group mx-sm-3 mb-2">
    ...
    Yes<input type="radio" class="form-control"  name="status" value="true" required>
     No<input type="radio" class="form-control"  name="status" value="false" required>
  </div>
  <!-- boolean -->
  <div>
        <input type="checkbox" id="Java" name="subjects"
               value="Java"  />
        <label for="Java">Java</label>
    </div>

    <div>
        <input type="checkbox" id="C++" name="subjects"
               value="C++" />
        <label for="C++">C++</label>
    </div>

    <div>
        <input type="checkbox" id="Python" name="subjects"
               value="Python" />
        <label for="Python">Python</label>
    </div>
    
    <div class="form-group mx-sm-3 mb-2">
    <label for="gender" class="sr-only">Gender</label><br>
    Male<input type="radio" class="form-control"  name="gender" value="MALE" required>
     Female<input type="radio" class="form-control"  name="gender" value="FEMALE" required>
  </div>
